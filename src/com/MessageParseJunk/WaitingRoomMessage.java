...
public class WaitingRoomMessage {
	public enum MessageType {
		Chat, TurnSudokuStatusOn, TurnMazeStatusOn, TurnDrawStatusOn, TurnStatusOff, JoinMazeRoom, JoinSudokuRoom, JoinDrawRoom, Ping
	}
	...
	public static WaitingRoomMessage Parse(String st) {
		...
		case 0:
			...
			break;
		case 1:
			t.Type = MessageType.TurnSudokuStatusOn;
			break;
		case 2:
		...
		case 4:
			...
			break;
		case 5:
			t.Type = MessageType.JoinSudokuRoom;
			t.Argument2 = d[2];
			break;
		case 6:
