...
public class SudokuGameRoomMessage {
	...
	public static SudokuGameRoomMessage Parse(String st) {
		...
		switch (de) {
		case 0:
			t.Type = SudokuGameRoomMessageType.SudokuData;
			t.SudokuData = parseSudokuData(d[1]);
			break;
		case 1:
			t.Type = SudokuGameRoomMessageType.SudokuMove;
			t.point = new SudokuPoint(Integer.valueOf(d[1]), new Point(Integer.parseInt(d[2]), Integer.parseInt(d[3])));
			break;
		case 2:
			t.Type = SudokuGameRoomMessageType.GameStarted;
			break;
		case 3:
			t.Type = SudokuGameRoomMessageType.GameFinish;
			break;
		case 4:
			t.Type = SudokuGameRoomMessageType.Leave;
			break;
		}
	...
	public SudokuGameRoomMessage(SudokuGameRoomMessageType t, SudokuPoint p) {
		Type = t;
		point = p;
	}

	public SudokuGameRoomMessage(SudokuGameRoomMessageType t) {
		Type = t;
	}

	public SudokuGameRoomMessage(SudokuGameRoomMessageType t, int[][] p) {
		Type = t;
		SudokuData = p;
	}
